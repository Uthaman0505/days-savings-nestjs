...
@InputType()
export class UpdateHouseLoanInput {
  @Field(() => String, { name: 'loan_name', nullable: true })
  @IsOptional()
  @IsString()
  @Length(1, 120)
  loan_name?: string;
  ...
  @Field(() => String, { name: 'loan_account_number', nullable: true })
  @IsOptional()
  @IsString()
  @Length(1, 64)
  ...
  @Field(() => Int, { name: 'monthly_installment_cents', nullable: true })
  @IsOptional()
  @IsInt()
  @Min(1)
